...
/*
    Maintenance History
    ===================
	ver 3.3 : 20 March 2011 
	- added the three following functions 
      static void FileCollection(stdStr &dir);
	  static std::vector<stdStr> gethvector();
	  static std::vector<stdStr> getcppvector();
