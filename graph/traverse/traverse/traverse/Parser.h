...
/*
  ...
  Maintenance History:
  ====================
  ver 1.3 : 17 March 2011
  - added a new function to parser class
    static void Parsing(std::string);
  - Referred the parser stub created the professor Jim Fawcett
    to create the above function.
