...
namespace edu.syr.eskimodb.tableserver
{
  ...
  class TestWriter
  {
    ...
    {
      string filename = "C:\\Users\\TestBinary.dat";
      ...
      if (File.Exists(fileName))
      {
        ...
        try
        {
          ...
          if (count != 0)
          {
            ...
            // code to extract the header and padding from the Binary File
            ...
            for (int i = 1; i <= 3; i++)
            {
              ...
              //code to extract PrimaryKey,RowIndex, color from the Binary File
