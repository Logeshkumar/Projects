...
namespace edu.syr.cse784.eskimodb.sharedobjs
{
    public interface IRestAPI
    {
        ...
        bool CreateNewUser(string newUser, string newUserPwd, string token);
        ...
        /// </returns>
        bool AuthenticateUser(string Username, string Password, out string token);
        ...
        /// </returns>
        bool ChangeUserPrivilege(string userName, bool administrator, string token);
        ...
        /// false when operation fails
        /// </returns>
        bool ChangePassword(string userName, string pwd, string token);
